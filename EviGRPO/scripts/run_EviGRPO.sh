...
DEFAULT_LOCAL_DIR="${BASE_OUTPUT_DIR}/checkpoints/${PROJECT_NAME}/${EXPERIMENT_NAME}"
...
LOG_DIR="logs/${PROJECT_NAME}_${EXPERIMENT_NAME}"
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_DIR}/remote_rm_${TIMESTAMP}.log"

# 6. 执行训练
echo "================================================================================"
echo "EXECUTING VERL GRPO TRAINING COMMAND"
echo "Output Dir : ${DEFAULT_LOCAL_DIR}"
echo "Log File   : ${LOG_FILE}"
echo "================================================================================"

python3 -m verl.trainer.main_ppo "${TRAIN_ARGS[@]}" 2>&1 | tee "${LOG_FILE}"
